  ...
  const features = [
    {
      ...
      description:
        "Automatically extract and analyze candidate information from resumes with our advanced AI parsing technology.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Candidate Matching",
      description:
        "Match candidates to job requirements with precision using our intelligent matching algorithms.",
    },
    {
      icon: <PieChart className="h-6 w-6" />,
      title: "Profit Optimization",
      description:
        "Optimize your recruitment budget and maximize ROI with data-driven insights and recommendations.",
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: "TalentPulse-Powered Insights",
      description:
        "Gain valuable insights into your recruitment process with our TalentPulse-powered analytics dashboard.",
    },
    {
      icon: <Brain className="h-6 w-6" />,
      title: "Intelligent Screening",
      description:
        "Automate initial candidate screening with TalentPulse to save time and improve quality of hires.",
    },
    {
      icon: <Target className="h-6 w-6" />,
      title: "Precision Targeting",
      description:
        "Target the right candidates with TalentPulse-powered job posting optimization and candidate sourcing.",
    },
    {
      icon: <BarChart3 className="h-6 w-6" />,
      title: "Performance Analytics",
      description:
        "Track and analyze recruitment performance metrics to continuously improve your hiring process.",
    },
    {
      icon: <Briefcase className="h-6 w-6" />,
      title: "Workflow Automation",
      description:
        "Streamline your recruitment workflow with automated scheduling, notifications, and follow-ups.",
    },
  ];
            ...
            <HighlighterItem className="rounded-3xl p-6">
              <div className="relative z-20 h-full overflow-hidden rounded-3xl border border-border bg-background">
                ...
                <div className="flex justify-center">
                  <div
                    className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row"
                    ref={scope}
                  >
