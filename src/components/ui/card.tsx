  ...
  "rounded-lg border bg-card text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        interactive:
          "shadow-sm hover:shadow-lg hover:-translate-y-1 cursor-pointer hover:border-primary/20",
        flat: "shadow-none border-0 bg-muted/30",
        outline: "shadow-none border-2 hover:border-primary/50",
        gradient:
          "bg-gradient-to-br from-card to-muted/20 shadow-md hover:shadow-lg hover:-translate-y-0.5",
      },
      padding: {
        default: "",
        none: "[&>*]:p-0",
