...
const aggregateToWeekly = (dailyData: any[]) => {
  ...
  return Object.values(weeks).map((week: any) => ({
    ...
    timeToHire: Math.floor(Math.random() * 5) + 20,
...
const aggregateToMonthly = (dailyData: any[]) => {
  ...
  return Object.values(months).map((month: any) => ({
    ...
    timeToHire: Math.floor(Math.random() * 5) + 22,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div className="bg-muted/50 p-3 rounded-lg">
            ...
            <div className="mt-1 text-lg font-bold">
              {data.reduce(
                (sum: number, item: any) => sum + item.screenings,
                0
              )}
            </div>
          </div>
          ...
          <div className="bg-muted/50 p-3 rounded-lg">
            ...
            <div className="mt-1 text-lg font-bold">
              {data.reduce((sum: number, item: any) => sum + item.hires, 0)}
            </div>
          </div>
        </div>
      </CardContent>
