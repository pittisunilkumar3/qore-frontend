...
const LandingPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900">
          ...
          >
            ...
            >
              <span className="relative">
                Coming Soon
                <span className="absolute -top-1 -right-7 px-1.5 py-0.5 rounded-full text-xs bg-primary text-white">
                  New
                </span>
              </span>
            </a>
      ...
      <section className="py-12 bg-gradient-to-r from-recruit-primary/5 to-recruit-secondary/5">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              <div className="text-3xl font-bold text-recruit-primary mb-2">
                500+
              </div>
      ...
      <section
        id="benefits"
        className="py-20 bg-gradient-to-br from-recruit-primary/10 to-recruit-secondary/10"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Our platform offers distinct advantages for US consulting firms
              looking to optimize their recruitment process.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Maximize the difference between client budgets and candidate
                    offers with transparent profit calculations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Accelerate the recruitment process with AI screening and
                    workflow automation, cutting hiring time by up to 40%.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    AI-powered matching ensures only the most qualified
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    On-premise deployment ensures your sensitive candidate and
      ...
      <section id="roles" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              QORE provides customized experiences for everyone involved in the
              recruitment process.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Oversee the entire recruitment operation with high-level metrics
                on team performance, hiring stats, and financial data.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Manage budgets, set profit splits, and track your team's hiring
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Upload resumes, manage screenings, and track candidates
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Access candidate information, conduct interviews, and provide
                structured feedback.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center text-sm">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Create an account, monitor application status, complete
                screenings, and respond to interview invitations.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center text-sm">
                  <CheckCircle2 className="h-4 w-4 text-green-600 mr-2" />
            ...
            <div className="relative bg-gradient-to-br from-recruit-primary/80 to-recruit-secondary/80 p-8 rounded-xl shadow-sm border border-recruit-primary/20 text-white overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-6 text-white/90">
                  Experience the power of AI-driven recruitment tailored for
      ...
      <section
        ...
        className="py-20 bg-gradient-to-br from-recruit-primary/5 to-recruit-secondary/5"
      >
        <div className="container mx-auto px-4 text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            We're constantly innovating to bring you the most powerful
            recruitment tools in the industry.
          </p>
        </div>
