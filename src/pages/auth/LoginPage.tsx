      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-recruit-primary to-recruit-secondary p-8 text-white flex flex-col justify-center">
          <div>
            ...
            <p className="mb-6">
              AI-powered recruitment platform designed for US consulting
              companies. Streamline your hiring process with intelligent tools.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">
                    Configure budget splits between client budget and candidate
                    offers
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">
                    Customized views for CEO, Branch Manager, Marketing Head,
                    Marketing Supervisor, Marketing Recruiter, Marketing
                    Associate, and Applicant
                  </p>
                </div>
              </div>
            </div>
